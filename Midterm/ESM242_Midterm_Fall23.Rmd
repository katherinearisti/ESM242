...
```{r}
period=11
obj_stock_func <- function(choice, int_state, p, a, b, gamma, alpha, discount, final_state){ 
...
constraint_function <- function(choice, int_state, a, b, p, gamma, alpha, discount, final_state){
  
  state <-vector(mode="numeric",length=11)
...
out_2a=nloptr(x0 = rep(0.1, times=period),
              int_state = 40, 
...
```{r}
period = 11
stock_2a <- function(choice, int_state=40, period=11, a=2, b=-0.25, p=100, alpha=2, gamma=0.2, discount=1/1.04, final_state=25){
...
stock_2b <- function(choice, int_state=40, period=10, a=2, b=-0.25, p=150, alpha=2, gamma=0.2, discount=1/1.04){
...
tbl_2b=round(stock_2a(out_2b$solution),2)    
