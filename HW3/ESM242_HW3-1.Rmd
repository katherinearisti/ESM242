...
<span style="color: blue;">**Solution**</span>
```{r}
obj_fcn_1_infinite <- function(choice,A,a,b,c,p,discount){
  
   Q=(exp(a-b/choice)) + A
  benefits = (p*Q*exp(-discount*choice)-c +   (p*Q*exp(-discount*choice)-c)/(1-exp(-discount*choice))*exp(-discount * choice))
...
out_tree2b=nloptr(x0=10, #not sure if this is the correct x0
          eval_f=obj_fcn_1_infinite,
          lb=0,
          opts = options,
...
print (round( out_tree2b$solution, 3 ))
print(-out_tree2b$objective)
